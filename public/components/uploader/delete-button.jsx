        ...
        if (this.state.deletable || this.state.deleting || !onlyRenderIfDeletable) {
            return (
                <button aria-label='delete'
                        ...
                        disabled={ onlyRenderIfDeletable ? (!this.state.deletable || this.state.deleting) : false }
                        onClick= { onlyRenderIfDeletable ? this.state.deletable && !this.state.deleting && this._onClick : this._onClick }
                        { ...elementProps }
                >
                    { content }
                </button>
